...
PostUp = '/usr/local/bin/wireguardup.sh'
PostDown = '/usr/local/bin/wireguarddown.sh'
...
function edit_wireguard() {
	...
	sed -i -e "/\[Interface\]/a PostUp = '/usr/local/bin/wireguardup.sh'\nPostDown = '/usr/local/bin/wireguarddown.sh'" "${VPN_CONFIG}"
...
function start_wireguard() {
	...
	source /usr/local/bin/iptable.sh
